...
#[test]
fn test_ascon_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash ascon",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<ascon_hash::AsconHash>::default().examples())
}
...
#[test]
fn test_ascon_a_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash ascon-a",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<ascon_hash::AsconAHash>::default().examples())
}
...
#[test]
fn test_belt_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash belt",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<belt_hash::BeltHash>::default().examples())
}
...
#[test]
fn test_blake2s_256_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash blake2s-256",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<blake2::Blake2s256>::default().examples())
}
...
impl Hasher for blake3::Hasher {
  ...
  fn examples() -> Vec<Example<'static>> {
    vec![
      Example {
        description: "Return the blake3 hash of a string, hex-encoded",
        example: "'abcdefghijklmnopqrstuvwxyz' | hash blake3",
        result: Some(Value::string(
          "2468eec8894acfb4e4df3a51ea916ba115d48268287754290aae8e9e6228e85f".to_owned(),
          Span::test_data(),
        )),
      },
      Example {
        description: "Return the blake3 hash of a string, as binary",
        example: "'abcdefghijklmnopqrstuvwxyz' | hash blake3 --binary",
        result: Some(Value::binary(
          vec![0x24,0x68,0xee,0xc8,0x89,0x4a,0xcf,0xb4,0xe4,0xdf,0x3a,0x51,0xea,0x91,0x6b,0xa1,0x15,0xd4,0x82,0x68,0x28,0x77,0x54,0x29,0x0a,0xae,0x8e,0x9e,0x62,0x28,0xe8,0x5f],
          Span::test_data(),
        )),
      },
      Example {
        description: "Return the blake3 hash of a file's contents",
        example: "open ./nu_0_24_1_windows.zip | hash blake3",
        result: None,
      },
    ]
  }
...
#[test]
fn test_blake3_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash blake3",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<blake3::Hasher>::default().examples())
}
...
#[test]
fn test_fsb160_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash fsb160",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<fsb::Fsb160>::default().examples())
}
...
#[test]
fn test_fsb224_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash fsb224",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<fsb::Fsb224>::default().examples())
}
...
#[test]
fn test_fsb256_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash fsb256",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<fsb::Fsb256>::default().examples())
}
...
#[test]
fn test_fsb384_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash fsb384",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<fsb::Fsb384>::default().examples())
}
...
#[test]
fn test_fsb512_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash fsb512",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<fsb::Fsb512>::default().examples())
}
...
#[test]
fn test_gost94_crypto_pro_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash gost94-crypto-pro",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<gost94::Gost94CryptoPro>::default().examples())
}
...
#[test]
fn test_gost94_ua_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash gost94-ua",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<gost94::Gost94UA>::default().examples())
}
...
#[test]
fn test_gost94_2015_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash gost94-2015",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<gost94::Gost94s2015>::default().examples())
}
...
impl Hasher for groestl::Groestl224 {
  ...
  fn examples() -> Vec<Example<'static>> {
    vec![
      Example {
        description: "Return the groestl224 hash of a string, hex-encoded",
        example: "'abcdefghijklmnopqrstuvwxyz' | hash groestl224",
        result: Some(Value::string(
      ...
      Example {
        description: "Return the groestl224 hash of a string, as binary",
        example: "'abcdefghijklmnopqrstuvwxyz' | hash groestl224 --binary",
        result: Some(Value::binary(
      ...
      Example {
        description: "Return the groestl224 hash of a file's contents",
        example: "open ./nu_0_24_1_windows.zip | hash groestl224",
        result: None,
      },
    ]
  }
...
#[test]
fn test_groestl224_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash groestl224",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<groestl::Groestl224>::default().examples())
}
...
#[test]
fn test_groestl256_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash groestl256",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<groestl::Groestl256>::default().examples())
}
...
#[test]
fn test_groestl384_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash groestl384",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<groestl::Groestl384>::default().examples())
}
...
#[test]
fn test_groestl512_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash groestl512",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<groestl::Groestl512>::default().examples())
}
...
#[test]
fn test_jh224_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash jh224",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<jh::Jh224>::default().examples())
}
...
#[test]
fn test_jh256_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash jh256",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<jh::Jh256>::default().examples())
}
...
#[test]
fn test_jh384_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash jh384",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<jh::Jh384>::default().examples())
}
...
#[test]
fn test_jh512_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash jh512",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<jh::Jh512>::default().examples())
}
...
#[test]
fn test_md2_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash md2",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<md2::Md2>::default().examples())
}
...
#[test]
fn test_md4_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash md4",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<md4::Md4>::default().examples())
}
...
#[test]
fn test_ripemd128_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash ripemd128",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<ripemd::Ripemd128>::default().examples())
}
...
#[test]
fn test_ripemd160_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash ripemd160",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<ripemd::Ripemd160>::default().examples())
}
...
#[test]
fn test_ripemd256_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash ripemd256",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<ripemd::Ripemd256>::default().examples())
}
...
#[test]
fn test_ripemd320_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash ripemd320",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<ripemd::Ripemd320>::default().examples())
}
...
#[test]
fn test_sha1_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash sha1",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sha1::Sha1>::default().examples())
}
...
#[test]
fn test_sha224_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash sha224",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sha2::Sha224>::default().examples())
}
...
#[test]
fn test_sha384_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash sha384",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sha2::Sha384>::default().examples())
}
...
#[test]
fn test_sha512_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash sha512",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sha2::Sha512>::default().examples())
}
...
#[test]
fn test_sha512_224_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash sha512-224",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sha2::Sha512_224>::default().examples())
}
...
#[test]
fn test_sha512_256_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash sha512-256",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sha2::Sha512_256>::default().examples())
}
...
#[test]
fn test_sha3_224_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash sha3-224",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sha3::Sha3_224>::default().examples())
}
...
#[test]
fn test_sha3_256_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash sha3-256",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sha3::Sha3_256>::default().examples())
}
...
#[test]
fn test_sha3_384_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash sha3-384",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sha3::Sha3_384>::default().examples())
}
...
#[test]
fn test_sha3_512_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash sha3-512",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sha3::Sha3_512>::default().examples())
}
...
#[test]
fn test_keccak224_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash keccak224",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sha3::Keccak224>::default().examples())
}
...
#[test]
fn test_keccak256_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash keccak256",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sha3::Keccak256>::default().examples())
}
...
#[test]
fn test_keccak384_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash keccak384",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sha3::Keccak384>::default().examples())
}
...
#[test]
fn test_keccak512_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash keccak512",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sha3::Keccak512>::default().examples())
}
...
#[test]
fn test_shabal192_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash shabal192",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<shabal::Shabal192>::default().examples())
}
...
#[test]
fn test_shabal224_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash shabal224",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<shabal::Shabal224>::default().examples())
}
...
#[test]
fn test_shabal256_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash shabal256",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<shabal::Shabal256>::default().examples())
}
...
#[test]
fn test_shabal384_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash shabal384",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<shabal::Shabal384>::default().examples())
}
...
#[test]
fn test_shabal512_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash shabal512",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<shabal::Shabal512>::default().examples())
}
...
#[test]
fn test_skein256_32_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash skein256-32",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<skein::Skein256::<skein::consts::U32>>::default().examples())
}
...
#[test]
fn test_skein256_64_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash skein256-64",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<skein::Skein256::<skein::consts::U64>>::default().examples())
}
...
#[test]
fn test_skein256_128_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash skein256-128",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<skein::Skein256::<skein::consts::U128>>::default().examples())
}
...
#[test]
fn test_skein512_32_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash skein512-32",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<skein::Skein512::<skein::consts::U32>>::default().examples())
}
...
#[test]
fn test_skein512_64_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash skein512-64",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<skein::Skein512::<skein::consts::U64>>::default().examples())
}
...
#[test]
fn test_skein512_128_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash skein512-128",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<skein::Skein512::<skein::consts::U128>>::default().examples())
}
...
#[test]
fn test_skein1024_32_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash skein1024-32",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<skein::Skein1024::<skein::consts::U32>>::default().examples())
}
...
#[test]
fn test_skein1024_64_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash skein1024-64",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<skein::Skein1024::<skein::consts::U64>>::default().examples())
}
...
#[test]
fn test_skein1024_128_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash skein1024-128",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<skein::Skein1024::<skein::consts::U128>>::default().examples())
}
...
#[test]
fn test_sm3_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash sm3",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<sm3::Sm3>::default().examples())
}
...
#[test]
fn test_streebog256_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash streebog256",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<streebog::Streebog256>::default().examples())
}
...
#[test]
fn test_streebog512_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash streebog512",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<streebog::Streebog512>::default().examples())
}
...
#[test]
fn test_tiger_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash tiger",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<tiger::Tiger>::default().examples())
}
...
#[test]
fn test_tiger2_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash tiger2",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<tiger::Tiger2>::default().examples())
}
...
#[test]
fn test_whirlpool_examples() -> Result<(), ShellError> {
  nu_plugin_test_support::PluginTest::new
    (
      "hash whirlpool",
      HashesPlugin.into()
    )?
    .test_examples(&GenericHasher::<whirlpool::Whirlpool>::default().examples())
}
